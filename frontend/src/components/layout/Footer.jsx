        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Cung cấp thực phẩm sạch, sản phẩm chăm sóc sức khỏe chất lượng cao 
              với dịch vụ thanh toán VietQR tiện lợi.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">support@hnfood.vn</span>
              </div>
              <div className="flex items-start space-x-3">
                <ClockIcon className="h-5 w-5 text-primary-400 mt-1 flex-shrink-0" />
                <div className="text-gray-300">
                  <div>Thứ 2 - Thứ 6: 8:00 - 18:00</div>
                  <div>Thứ 7 - CN: 9:00 - 17:00</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              ...
              <div className="flex space-x-4">
                <div className="bg-white rounded px-3 py-1">
                  <span className="text-primary-600 font-bold text-sm">VietQR</span>
                </div>
                <div className="bg-white rounded px-3 py-1">
                  <span className="text-gray-800 font-bold text-sm">COD</span>
                </div>
                <div className="bg-white rounded px-3 py-1">
                  <span className="text-gray-800 font-bold text-sm">Banking</span>
                </div>
              </div>
            </div>
            ...
            <div className="text-center md:text-right">
              <p className="text-gray-400 text-sm">
                © 2024 HN FOOD. Tất cả quyền được bảo lưu.
              </p>
            </div>
          </div>
        </div>
